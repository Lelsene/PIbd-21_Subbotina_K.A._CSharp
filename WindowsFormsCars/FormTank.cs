...
using static WindowsFormsCars.Tank;
...
namespace WindowsFormsCars
{
    public partial class FormTank : Form
    {
        ...
        private void buttonCreate_Click(object sender, EventArgs e)
        {
            ...
            tank = new Tank(rnd.Next(100, 300), rnd.Next(1000, 2000), Color.Blue, Color.Yellow);
            tank.SetPosition(pictureBoxCars.Width - rnd.Next(100, 190), pictureBoxCars.Height - rnd.Next(60, 150), pictureBoxCars.Width,
